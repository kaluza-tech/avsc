...
function Type(schema, opts) {
  ...
  this.pii = schema && schema.pii ? schema.pii : undefined;
...
RecordType.prototype._deref = function (schema, opts) {
  schema.fields = this.fields.map(function (field) {
    ...
    if (opts.exportAttrs) {
      ...
      var fieldPii = field.pii;
      if (fieldPii !== undefined) {
        fieldSchema.pii = fieldPii;
      }
    }
    return fieldSchema;
  });
...
function Field(schema, opts) {
  ...
  this.pii = schema.pii !== undefined ? schema.pii : undefined;
